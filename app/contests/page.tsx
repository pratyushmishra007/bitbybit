...
export default function ContestsPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-linear-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              {session?.user?.email && (
                <Link
                  ...
                  className="flex-shrink-0 px-4 py-2 bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-lg font-semibold text-sm transition-all shadow-lg shadow-green-500/30 flex items-center gap-2"
                >
          ...
          {/* CTA Section */}
          <div className="mt-16 bg-linear-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-center">
