-- Contests System Database Schema
...
-- Create some test participants (you'll need to replace with actual user IDs from your database)
-- This is just example structure - actual IDs need to come from your users table
-- INSERT INTO contest_participants (contest_id, user_id, total_score, problems_solved, rank)
-- SELECT 
--   c.id,
--   u.id,
--   FLOOR(RANDOM() * 500),
